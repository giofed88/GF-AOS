# GF-AOS Professional Studio v0.4.0

Plugin Codex per instradamento professionale, pianificazione, inventario e Document Intelligence locale, scadenze, brief e verifica. Le skill sono istruzioni operative; **nessun server MCP, collegamento Drive, automazione Telegram o scheduler è attivo in questo pacchetto**. Le integrazioni richiedono configurazione separata.
